...
if (-not $env:WT_SESSION) {
    ...
    if ($wt) {
        ...
        try {
            $tmp = "$env:TEMP\FiveM_Optimizer_$(Get-Random).ps1"
            Invoke-RestMethod 'https://raw.githubusercontent.com/PhuwanaiX2/ono/main/FiveM_Optimizer.ps1' | Out-File $tmp -Encoding UTF8
